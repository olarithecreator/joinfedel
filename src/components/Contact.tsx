        ...
        <div className="grid lg:grid-cols-2 gap-20">
          <div className="space-y-8 animate-fade-in" style={{animationDelay: '0.3s'}}>
            ...
            <div className="space-y-8">
              <div className="group glass p-6 rounded-2xl hover:bg-white/10 transition-all duration-300">
                ...
                <div className="text-white/90">plot 6A centenary</div>
              </div>
              <div className="group glass p-6 rounded-2xl hover:bg-white/10 transition-all duration-300">
                <div className="text-sm text-purple-400 tracking-wide mb-2 group-hover:text-purple-300 transition-colors">
                  PHONE
                </div>
                <div className="text-white/90">+234-8119-471875</div>
              </div>
              <div className="group glass p-6 rounded-2xl hover:bg-white/10 transition-all duration-300">
                <div className="text-sm text-purple-400 tracking-wide mb-2 group-hover:text-purple-300 transition-colors">
                  EMAIL
          ...
          <div className="glass-dark rounded-3xl p-8 animate-fade-in-up" style={{animationDelay: '0.6s'}}>
            ...
            >
              ...
              <div>
                <label className="block text-sm text-gray-300/80 tracking-wide mb-3">ORGANIZATION</label>
                <input 
                  type="text" 
                  className="w-full px-4 py-4 bg-white/5 text-white placeholder-gray-400 border border-gray-600/50 rounded-xl focus:border-purple-400 focus:outline-none focus:ring-2 focus:ring-purple-400/20 transition-all duration-300"
                />
              ...
              <div>
                <label className="block text-sm text-gray-300/80 tracking-wide mb-3">PROGRAM INTEREST</label>
                <select className="w-full px-4 py-4 bg-white/5 text-white border border-gray-600/50 rounded-xl focus:border-purple-400 focus:outline-none focus:ring-2 focus:ring-purple-400/20 transition-all duration-300">
