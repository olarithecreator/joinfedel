          ...
          <nav className="hidden md:flex items-center space-x-12">
            {isHomePage ? (
              <>
                ...
                <a href="#programs" className="text-white/80 hover:text-purple-400 transition-all duration-300 text-sm tracking-wide relative group">
                  Programs
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-purple-400 transition-all duration-300 group-hover:w-full"></span>
                </a>
            ...
            <nav className="py-6 px-6 space-y-6">
              {isHomePage ? (
                <>
                  ...
                  <a href="#programs" className="block text-white hover:text-purple-400 transition-colors text-sm tracking-wide">
                    Programs
                  </a>
